...
const orientationStyle = StyleSheet.create({
  landscape: {
    ...Device.select({
      ...
      iPhone11: {
        height: BAR_HEIGHT_IOS + Device.IPHONE_11_BOTTOM_LANDSCAPE,
        paddingBottom: Device.IPHONE_11_BOTTOM_LANDSCAPE
      },
      iPhone12: {
        height: BAR_HEIGHT_IOS + Device.IPHONE_12_BOTTOM_LANDSCAPE,
        paddingBottom: Device.IPHONE_12_BOTTOM_LANDSCAPE
      }
    })
  },
  portrait: {
    ...Device.select({
      ...
      iPhone11: {
        height: BAR_HEIGHT_IOS + Device.IPHONE_11_BOTTOM_PORTRAIT,
        paddingBottom: Device.IPHONE_11_BOTTOM_PORTRAIT
      },
      iPhone12: {
        height: BAR_HEIGHT_IOS + Device.IPHONE_12_BOTTOM_PORTRAIT,
        paddingBottom: Device.IPHONE_12_BOTTOM_PORTRAIT
      }
    })
  }
})
